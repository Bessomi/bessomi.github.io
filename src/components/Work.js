    ...
    return (
      <div className="center-wrapper">
        <div className="work-container">
          ...
          <div className="work-logo-box work-itemA1"> <img src={MONOK} className="work-logo"/> </div>
          ...
          <div className="work-logo-box work-itemB1"> <img src={SU} className="work-logo"/> </div>
          ...
          <div className="work-logo-box work-itemC1"> <img src={KTH} className="work-logo"/> </div>
          ...
          <div className="work-logo-box work-itemD1"> <img src={TELE2} className="work-logo"/> </div>
